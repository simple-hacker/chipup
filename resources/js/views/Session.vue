<template>
	<div class="flex flex-col w-full relative text-white">
		<div class="absolute top-5 right-5 w-full">
		...
		<div class="grid grid-cols-6 gap-2 md:gap-3 mt-2 md:mt-4">
			<div class="col-span-6 md:col-span-3 md:row-span-2 flex-col bg-card border border-muted-dark rounded-lg p-3 text-lg">
				...
				<div class="mb-2 md:mb-0 flex items-center p-0 md:p-2">
					...
					<input v-if="editing" type="text" class="p-1 text-lg" v-model="cash_game.location" placeholder="Location">
				</div>
				<div class="mb-2 md:mb-0 flex items-center p-0 md:p-2">
			...
			<div class="col-span-6 md:col-span-3 md:row-span-2 flex flex-col justify-between md:justify-start bg-card border border-muted-dark rounded-lg p-3">
