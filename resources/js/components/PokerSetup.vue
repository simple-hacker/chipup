        ...
        <form-wizard ref="formwizard" title="" subtitle="" color="#409858" errorColor="#aa332e" class="text-white">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-col items-center">
                        <input
                            ...
                            step="0.01"
                            min="0"
                            class="w-full md:w-3/4 border p-3"
            ...
            <tab-content title="Game Type" icon="fas fa-star">
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-col items-center">
                        <select v-model="default_variant" class="w-full md:w-3/4 p-3 mb-2" :class="{ 'error-input' : errors.default_variant_id }">
                    ...
                    <div class="flex flex-col items-center">
                        <select v-model="default_table_size" class="w-full md:w-3/4 p-3 mb-2" :class="{ 'error-input' : errors.default_table_size_id }">
    ...
    export default {
        ...
        methods: {
            bankrollMustBePositive() {
                if (this.bankroll < 0) {
                    this.errors = { bankroll: ['Bankroll amount must be zero or greater'] }
                    return false
                }
