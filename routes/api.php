...
// CashGame Routes
Route::prefix('cash')->name('cash.')->middleware(['auth', 'setup.complete'])->group(function () {
...
// Tournament Routes
Route::prefix('tournament')->name('tournament.')->middleware(['auth', 'setup.complete'])->group(function () {
...
// BuyIn Routes
Route::prefix('buyin')->name('buyin.')->middleware(['auth', 'setup.complete'])->group(function () {
...
// Expenses Routes
Route::prefix('expense')->name('expense.')->middleware(['auth', 'setup.complete'])->group(function () {
...
// CashOut Routes
Route::prefix('cashout')->name('cashout.')->middleware(['auth', 'setup.complete'])->group(function () {
...
// Rebuy Routes
Route::prefix('rebuy')->name('rebuy.')->middleware(['auth', 'setup.complete'])->group(function () {
...
// AddOn Routes
Route::prefix('addon')->name('addon.')->middleware(['auth', 'setup.complete'])->group(function () {
